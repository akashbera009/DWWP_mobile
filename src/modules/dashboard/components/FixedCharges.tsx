...
const FIXED_CHARGES = [
    { label: 'Base Rate', value: '₹4.50/unit', color: colors.primary },
    { label: 'Service Fee', value: '₹120/mo', color: colors.activeDot },
    { label: 'Maintenance', value: '₹80/mo', color: colors.warning },
]
